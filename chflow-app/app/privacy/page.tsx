      ...
      <div style={cardStyle}>
        ...
        <div style={{ fontSize: 13, color: "var(--ink-mid)", lineHeight: 1.75 }}>
          ...
          <ul style={ulStyle}>
            ...
            <li>
              <strong>자동출석 기능 이용 시</strong>: 기기의 정확한 위치정보
              (앱이 닫혀 있거나 사용 중이 아닐 때 포함), 교회 구역 진입·최종 확인 시각,
              체류시간 및 출석 후보·확정 상태
            </li>
          </ul>
          ...
          <ul style={ulStyle}>
            ...
            <li>교회 반경 진입 및 체류 여부 확인을 통한 자동출석 후보 생성·출석 확인</li>
            <li>가족·목장 단위 커뮤니케이션 및 공지 전달</li>
            <li>서비스 운영, 부정 이용 방지, 문의 응대</li>
          </ul>

          <h3 style={h3Style}>3. 위치정보의 접근·수집 및 이용</h3>
          <p style={pStyle}>
            자동출석 기능을 사용하도록 동의한 경우, 서비스는 사용자가 앱을 닫았거나
            앱을 사용하지 않는 동안에도 기기의 위치정보에 접근하여 교회 반경 진입과 체류 여부를 확인합니다.
            이 기능은 교회 출석 후보를 자동으로 생성하고 출석 여부를 확인하는 목적으로만 사용됩니다.
          </p>
          <ul style={ulStyle}>
            <li>
              기기의 원시 GPS 좌표는 교회 반경 여부를 계산하기 위해 기기 안에서 처리하며,
              서버로 전송하거나 저장하지 않습니다.
            </li>
            <li>
              서버에는 교회 구역 식별정보, 출석일, 진입·최종 확인 시각, 체류시간,
              출석 후보·확정 상태만 저장됩니다.
            </li>
            <li>
              위치정보와 자동출석 기록은 광고에 사용하거나 판매하지 않으며,
              출석 관리 권한이 있는 교회 담당자 외의 제3자에게 제공하지 않습니다.
            </li>
            <li>
              사용자는 안내창에서 동의를 거부하거나 기기 설정에서 위치 권한을 해제할 수 있습니다.
              권한을 해제하면 자동출석 기능만 중지되며 다른 앱 기능은 계속 이용할 수 있습니다.
            </li>
          </ul>

          <h3 style={h3Style}>4. 보유 및 이용 기간</h3>
          <ul style={ulStyle}>
            <li>회원 탈퇴 시 로그인 계정과 부서 소속은 즉시 해제·삭제됩니다.</li>
            <li>교적 원본과 회원이 작성한 글·댓글·생성물은 사역 운영 및 파생 자료 연결을 위해 탈퇴 회원 정보로 보관될 수 있습니다.</li>
            <li>관리자는 보관된 탈퇴 회원과 콘텐츠를 별도 관리하며, 법령 또는 운영 목적이 끝나면 파기합니다.</li>
            <li>관계 법령에 따라 보존이 필요한 경우 해당 법령에서 정한 기간 동안 보관</li>
          </ul>

          <h3 style={h3Style}>5. 만 14세 미만 아동의 개인정보</h3>
          <p style={pStyle}>
          ...
          <h3 style={h3Style}>8. 개인정보의 안전성 확보 조치</h3>
          <ul style={ulStyle}>
