...
| 메뉴명 | 우리반 아이 정보 |
| 대분류 | 부서 내부 메뉴 > 학생관리 |
| 간단 설명 | 담당 반 학생 정보를 확인한다. |
| 사용자/권한 | 초등1부 교사 이상 |
| 라우트 | /departments/d/[id]/my-class |
| 구현상태 | 구현 |
| 기준일 | 2026-06-05 |
...
- `app/departments/d/[id]/my-class/page.tsx`

## 3. 기능 목록

| 연번 | 내용 | 해당파일 | 동작원리 | 기능상세설명 |
|---:|---|---|---|---|
| 1 | 부서홈 메뉴 노출 | `app/departments/d/[id]/page.tsx` | MENU_CATEGORIES의 우리반 아이 정보 항목으로 정의된다. | 사용자 부서 등급과 부서 조건이 맞으면 카드가 표시된다. |
| 2 | 화면 이동 | `app/departments/d/[id]/my-class/page.tsx` | 클릭 시 /departments/d/[id]/my-class로 이동한다. | 담당 반 학생 정보를 확인한다. |
