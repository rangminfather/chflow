...
| 메뉴명 | 내 반 출결 |
| 대분류 | 부서 내부 메뉴 > 학생관리 |
| 간단 설명 | 담당 반 학생의 출석을 체크한다. |
| 사용자/권한 | 초등1부 교사 이상 |
| 라우트 | /departments/d/[id]/my-class-attendance |
| 구현상태 | 구현 |
| 기준일 | 2026-06-05 |
...
|---:|---|---|---|---|
| 1 | 부서홈 메뉴 노출 | `app/departments/d/[id]/page.tsx` | MENU_CATEGORIES의 내 반 출결 항목으로 정의된다. | 사용자 부서 등급과 부서 조건이 맞으면 카드가 표시된다. |
| 2 | 화면 이동 | `app/departments/d/[id]/my-class-attendance/page.tsx` | 클릭 시 /departments/d/[id]/my-class-attendance로 이동한다. | 담당 반 학생의 출석을 체크한다. |
