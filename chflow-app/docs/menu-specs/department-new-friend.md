...
| 메뉴명 | 새친구등록 |
| 대분류 | 부서 내부 메뉴 > 행정관리 |
| 간단 설명 | 새친구 등록카드와 생활기록부를 작성한다. |
| 사용자/권한 | 초등1부 총무/서기 이상 |
| 라우트 | /departments/d/[id]/new-friend |
| 구현상태 | 구현 |
| 기준일 | 2026-06-05 |
...
- `app/departments/d/[id]/new-friend/page.tsx`

## 3. 기능 목록

| 연번 | 내용 | 해당파일 | 동작원리 | 기능상세설명 |
|---:|---|---|---|---|
| 1 | 부서홈 메뉴 노출 | `app/departments/d/[id]/page.tsx` | MENU_CATEGORIES의 새친구등록 항목으로 정의된다. | 사용자 부서 등급과 부서 조건이 맞으면 카드가 표시된다. |
| 2 | 화면 이동 | `app/departments/d/[id]/new-friend/page.tsx` | 클릭 시 /departments/d/[id]/new-friend로 이동한다. | 새친구 등록카드와 생활기록부를 작성한다. |
