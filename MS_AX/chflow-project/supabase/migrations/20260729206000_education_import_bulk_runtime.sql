-- A staged source document can contain thousands of immutable raw rows.
-- Audit the batch/parsing event once; keep per-row audits for later review and
-- approval changes outside this bulk function.
