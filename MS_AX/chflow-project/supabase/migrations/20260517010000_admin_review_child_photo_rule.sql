-- Child rows usually do not have profile photos in the directory.
-- Missing photos should be reviewed for adult/office-bearing members, not for
-- child/dependent rows.
