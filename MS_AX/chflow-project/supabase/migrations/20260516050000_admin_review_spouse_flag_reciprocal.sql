-- Spouse validation should not require the spouse to be in the same household.
-- Some real couples are intentionally assigned to different households/pastures.
-- Treat spouse as valid when a reciprocal spouse record exists anywhere.
